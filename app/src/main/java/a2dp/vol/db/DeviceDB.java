...
public class DeviceDB {
	 ...
	 */
	public void update(BtDeviceModel bt) {
	 ...
	 */
	public void delete(BtDeviceModel bt) {
	 ...
	 */
	public long insert(BtDeviceModel btd) {
	 ...
	 */
	public BtDeviceModel getBTD(String imac) {
	 ...
	 */
	public Vector<BtDeviceModel> selectAlldb() {
		Vector<BtDeviceModel> list = new Vector<>();
		Cursor cursor = this.db.query(TABLE_NAME, new String[] { "desc1",
