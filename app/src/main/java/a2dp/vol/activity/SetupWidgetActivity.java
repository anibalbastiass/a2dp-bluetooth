...
public class SetupWidgetActivity extends Activity {
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            final Context context = SetupWidgetActivity.this;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mAppWidgetText.setText(loadTitlePref(SetupWidgetActivity.this, mAppWidgetId));
 ...
 /*       if (!receiver_registered) {
    ...
    void done() {
        ...
        Intent intent = new Intent(application, ConnectorService.class);
