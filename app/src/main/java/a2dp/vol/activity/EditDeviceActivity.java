      ...
      /*  if (android.os.Build.VERSION.SDK_INT > 27) {
        ...
        connbt.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                final Vector<BtDeviceModel> vec = myDB.selectAlldb();
                int j = vec.size();
                for (int i = 0; i < j; i++) {
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case ACTION_CHOOSE_APP:
                    pname = data.getStringExtra(ChooserActivity.EXTRA_PACKAGE_NAME);
                    appaction = "";
                    apptype = "";
                    appdata = "";
    ...
    private DialogInterface.OnClickListener mAppTypeDialogOnClick = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            switch (which) {
                case 0:
                    // Select App
                    i = new Intent(getBaseContext(), ChooserActivity.class);
                ...
                case 2:
                    // Custom Intent
                    i = new Intent(getBaseContext(), CustomIntentMakerActivity.class);
