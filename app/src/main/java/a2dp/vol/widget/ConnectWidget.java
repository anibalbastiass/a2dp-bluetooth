...
import a2dp.vol.activity.SetupWidgetActivity;
import a2dp.vol.service.ConnectorService;
import a2dp.vol.R;

/**
 * Implementation of App Widget functionality.
 * App Widget Configuration implemented in {@link SetupWidgetActivity ConnectWidgetConfigureActivity}
 */
public class ConnectWidget extends AppWidgetProvider {
    ...
    public static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        CharSequence widgetText = SetupWidgetActivity.loadTitlePref(context, appWidgetId);
    ...
    public void onDeleted(Context context, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            SetupWidgetActivity.deleteTitlePref(context, appWidgetId);
        }
    }
